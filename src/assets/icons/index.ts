...
export { ReactComponent as PieChartIcon2 } from './pie-chart.svg'
...
export { ReactComponent as PlataformaPaiIcon } from './pai.svg'

// export { PieChartIcon } from 'react-icons/fi'
